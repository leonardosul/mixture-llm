...
|---------|----------|-------------|
| [`openai_basic.py`](examples/openai_basic.py) | OpenAI | Simplest MoA with GPT-5.2-mini |
| [`openai_self_moa.py`](examples/openai_self_moa.py) | OpenAI | Self-MoA (6 samples, one model) |
| [`multi_provider.py`](examples/multi_provider.py) | OpenAI + Anthropic | Mix GPT-5.2 and Claude |
