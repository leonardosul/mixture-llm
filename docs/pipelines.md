...
## MoA with GPT-4o Aggregator (65.7% AlpacaEval)

The highest-scoring configuration uses GPT-4o as the final aggregator:
...
robust_moa = [
    Propose(["gpt-4o", "claude-sonnet-4-20250514", "llama-3.3-70b", "gemini-pro"]),
    Shuffle(),
    Dropout(0.2),
    Aggregate("gpt-4o"),
]
...
rank_aggregate = [
    Propose(["gpt-4o", "claude-sonnet-4-20250514", "llama-3.3-70b", "gemini-pro", "gpt-4o-mini"]),
    Rank("gpt-4o", n=3),  # Keep top 3
    Aggregate("gpt-4o"),
]
```
...
vote_pipeline = [
    Propose(["gpt-4o", "claude-sonnet-4-20250514", "llama-3.3-70b"], temp=0.3),
    Vote("gpt-4o"),
]
```
...
refine_pipeline = [
    Propose(["gpt-4o-mini", "claude-haiku", "llama-3.1-8b"]),
    Refine(["gpt-4o"]),  # GPT-4o improves each response
    Aggregate("gpt-4o"),
]
```
