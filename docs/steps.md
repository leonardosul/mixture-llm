...
```python
# Standard MoA layer
Synthesize(["gpt-4o", "claude-sonnet-4-20250514", "llama-3.3-70b"])
```
...
# Custom prompt
Aggregate("gpt-4o", prompt="Select the best response and return it verbatim.")
```
...
```python
# Use GPT-4o to refine all responses
Refine(["gpt-4o"])

# Different refiners for each response
Refine(["gpt-4o", "claude-sonnet-4-20250514"])
```
